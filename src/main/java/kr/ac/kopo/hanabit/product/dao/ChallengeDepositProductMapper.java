package kr.ac.kopo.hanabit.product.dao;
...
public interface ChallengeDepositProductMapper {

    public List<ChallengeDepositProductVO> selectAll();

    public ChallengeDepositProductVO selectOneById(Long id);
}
